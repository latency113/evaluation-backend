...
export var CourseAssignmentController;
(function (CourseAssignmentController) {
    CourseAssignmentController.getAllAssignmentsHandler = async (req, res) => {
        try {
    ...
    CourseAssignmentController.getAssignmentByIdHandler = async (req, res) => {
        try {
    ...
    CourseAssignmentController.createAssignmentHandler = async (req, res) => {
        try {
    ...
    CourseAssignmentController.updateAssignmentHandler = async (req, res) => {
        try {
            const id = parseInt(req.params.id);
            if (isNaN(id)) {
                return res.status(400).json({ message: "Invalid assignment ID" });
    ...
    CourseAssignmentController.deleteAssignmentHandler = async (req, res) => {
        try {
            const id = parseInt(req.params.id);
            if (isNaN(id)) {
                return res.status(400).json({ message: "Invalid assignment ID" });
