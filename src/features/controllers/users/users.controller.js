...
(function (UserController) {
    UserController.getAllUsersHandler = async (req, res) => {
        try {
    ...
    UserController.getUserByIdHandler = async (req, res) => {
        try {
    ...
    UserController.createUserHandler = async (req, res) => {
        try {
    ...
    UserController.updateUserHandler = async (req, res) => {
        try {
            const userId = parseInt(req.params.id);
            if (isNaN(userId)) {
                return res.status(400).json({ message: "Invalid user ID" });
    ...
    UserController.deleteUserHandler = async (req, res) => {
        try {
            const userId = parseInt(req.params.id);
            if (isNaN(userId)) {
                return res.status(400).json({ message: "Invalid user ID" });
