...
import { classroomSchema } from "./classrooms.schema";
import ExcelJS from 'exceljs';
export var ClassroomService;
(function (ClassroomService) {
    ClassroomService.getAllClassrooms = async (page = 1, limit = 10) => {
